...
describe("IcWebsocket class", () => {
  ...
  it("onmessage is called when the the ws gateway sends a message", async () => {
    ...
    const clientIncomingMessage: ClientIncomingMessage = {
      ...
      content: fromHex("d9d9f7a46a636c69656e745f6b657958205bf358639ab48f2d6fb6a0a48854405278bddeaaed6f58302ebad66e2d4a7de36c73657175656e63655f6e756d016974696d657374616d701b17748882ece5ad12676d6573736167654ed9d9f7a164746578746470696e67"),
    ...
    mockWsServer.send(IDL.encode([ClientIncomingMessageIdl], [clientIncomingMessage]));
  ...
  it("onerror is called when the application message is invalid", async () => {
    ...
    mockWsServer.send(IDL.encode([ClientIncomingMessageIdl], [invalidClientIncomingMessage]));
